 ...
 */
export function parametersGetParameters(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetParametersRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetParametersResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
