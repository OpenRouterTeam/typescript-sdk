 ...
 */
export function guardrailsListMemberAssignments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListMemberAssignmentsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListMemberAssignmentsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      guardrailsListMemberAssignments(
        client,
        security,
        {
          ...request!,
