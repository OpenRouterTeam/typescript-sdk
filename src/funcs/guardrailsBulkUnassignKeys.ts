 ...
 */
export function guardrailsBulkUnassignKeys(
  ...
  Result<
    models.BulkUnassignKeysResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkUnassignKeysFromGuardrailRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/guardrails/{id}/assignments/keys/remove")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BulkUnassignKeysResponse$inboundSchema),
