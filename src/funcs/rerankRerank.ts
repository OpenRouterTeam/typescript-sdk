...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateRerankRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateRerankResponse$inboundSchema),
    M.text(200, operations.CreateRerankResponse$inboundSchema, {
