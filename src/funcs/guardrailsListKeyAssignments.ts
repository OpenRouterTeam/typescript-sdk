 ...
 */
export function guardrailsListKeyAssignments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListKeyAssignmentsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListKeyAssignmentsResponse$inboundSchema, {
      key: "Result",
    }),
