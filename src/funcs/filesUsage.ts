 ...
 */
export function filesUsage(
  client: OpenRouterCore,
  request?: operations.GetFilesUsageRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetFilesUsageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFilesUsageRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/files/usage")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFilesUsageResponse$inboundSchema),
