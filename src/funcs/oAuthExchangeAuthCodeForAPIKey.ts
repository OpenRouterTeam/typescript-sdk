 ...
 */
export function oAuthExchangeAuthCodeForAPIKey(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ExchangeAuthCodeForAPIKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExchangeAuthCodeForAPIKeyResponse$inboundSchema),
