 ...
 */
export function observabilityDelete(
  ...
  Result<
    models.DeleteObservabilityDestinationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteObservabilityDestinationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteObservabilityDestinationResponse$inboundSchema),
