 ...
 */
export function systemOneCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateSystemoneRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/systemone")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DecisionsResponse$inboundSchema),
