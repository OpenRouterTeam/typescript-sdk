 ...
 */
export function scimListMappings(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListScimGroupMappingsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListScimGroupMappingsResponse$inboundSchema, {
      key: "Result",
    }),
