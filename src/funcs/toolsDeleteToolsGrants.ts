 ...
 * Revoke a grant
 */
export function toolsDeleteToolsGrants(
  client: OpenRouterCore,
  request: operations.DeleteToolsGrantsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.RevokeGrantResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteToolsGrantsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/tools/{fullName}/grants/{userId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RevokeGrantResponse$inboundSchema),
