...
export function datasetsGetSessionCost(
  ...
  PageIterator<
    Result<
      operations.GetSessionCostResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSessionCostRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSessionCostResponse$inboundSchema, {
      key: "Result",
    }),
