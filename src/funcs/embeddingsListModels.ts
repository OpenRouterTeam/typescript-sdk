...
export function embeddingsListModels(
  ...
  PageIterator<
    Result<
      operations.ListEmbeddingsModelsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListEmbeddingsModelsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEmbeddingsModelsResponse$inboundSchema, {
      key: "Result",
    }),
