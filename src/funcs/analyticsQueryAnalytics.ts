 ...
 */
export function analyticsQueryAnalytics(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.QueryAnalyticsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.QueryAnalyticsResponse$inboundSchema),
