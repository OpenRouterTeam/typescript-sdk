...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetRankingsDailyRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RankingsDailyResponse$inboundSchema),
