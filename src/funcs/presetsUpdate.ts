...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdatePresetRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdatePresetRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdatePresetResponse$inboundSchema),
