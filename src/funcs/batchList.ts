...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBatchesRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListBatchesResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr([400, 401, 429], errors.BatchErrorResponse$inboundSchema),
  ...
  const nextFunc = (
    ...
    const nextCursor = (responseData as { last_id: unknown | null }).last_id;
