 ...
 */
export function oAuthCreateOauthToken(
  client: OpenRouterCore,
  request: operations.CreateOauthTokenRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TokenExchangeResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateOauthTokenRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.TokenExchangeRequest || {}).map(
    ([k, v]) => {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TokenExchangeResponse$inboundSchema),
    M.jsonErr([400, 429], errors.OAuthErrorResponse$inboundSchema),
    M.jsonErr([500, 503], errors.OAuthErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
