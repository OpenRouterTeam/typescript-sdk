 ...
 */
export function videoGenerationGetVideoContent(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListVideosContentRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.stream(206, operations.ListVideosContentResponse$inboundSchema, {
      ctype: "video/mp4",
    }),
