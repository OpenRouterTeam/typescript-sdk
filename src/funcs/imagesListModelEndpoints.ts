 ...
 */
export function imagesListModelEndpoints(
  client: OpenRouterCore,
  request: operations.ListImageModelEndpointsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ImageModelEndpointsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListImageModelEndpointsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/images/models/{author}/{slug}/endpoints")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ImageModelEndpointsResponse$inboundSchema),
