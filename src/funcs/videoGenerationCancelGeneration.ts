 ...
 */
export function videoGenerationCancelGeneration(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateVideosCancelRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/videos/{jobId}/cancel")(pathParams);
  ...
  const context = {
    ...
    operationID: "createVideosCancel",
    oAuth2Scopes: null,
