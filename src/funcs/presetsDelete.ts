...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeletePresetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeletePresetResponse$inboundSchema),
