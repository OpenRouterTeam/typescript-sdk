 ...
 */
export function chatStreamChatCompletion(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.ChatStreamCompletionCreateParams$outboundSchema.parse(value),
    ...
    M.sse(
      ...
      z.instanceof(ReadableStream<Uint8Array>).transform(stream => {
        return new EventStream(stream, rawEvent => {
          ...
          return {
            value: operations.StreamChatCompletionResponseBody$inboundSchema
              .parse(rawEvent),
          };
        });
      }),
