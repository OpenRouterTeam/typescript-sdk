 ...
 */
export function videoGenerationGenerate(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateVideosRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.VideoGenerationResponse$inboundSchema),
