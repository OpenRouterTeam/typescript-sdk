 ...
 */
export function classificationsGetTaskClassifications(
  client: OpenRouterCore,
  request?: operations.GetTaskClassificationsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TaskClassificationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTaskClassificationsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TaskClassificationResponse$inboundSchema),
