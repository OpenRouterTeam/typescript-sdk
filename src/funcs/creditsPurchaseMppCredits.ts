 ...
 */
export function creditsPurchaseMppCredits(
  client: OpenRouterCore,
  request: operations.PurchaseMppCreditsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PurchaseMppCreditsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PurchaseMppCreditsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/credits/mpp")();
  ...
  const context = {
    ...
    operationID: "purchaseMppCredits",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PurchaseMppCreditsResponse$inboundSchema),
