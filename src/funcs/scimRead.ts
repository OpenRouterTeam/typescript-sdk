 ...
 */
export function scimRead(
  client: OpenRouterCore,
  request: operations.GetScimGroupMappingRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetScimGroupMappingResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetScimGroupMappingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetScimGroupMappingResponse$inboundSchema),
