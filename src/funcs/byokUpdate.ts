 ...
 */
export function byokUpdate(
  client: OpenRouterCore,
  request: operations.UpdateBYOKKeyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.UpdateBYOKKeyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateBYOKKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateBYOKKeyResponse$inboundSchema),
