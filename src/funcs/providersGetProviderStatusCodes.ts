 ...
 */
export function providersGetProviderStatusCodes(
  client: OpenRouterCore,
  request: operations.GetProviderStatusCodesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetProviderStatusCodesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetProviderStatusCodesRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    provider_slug: encodeSimple("provider_slug", payload.provider_slug, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/providers/{provider_slug}/status-codes")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "getProviderStatusCodes",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetProviderStatusCodesResponse$inboundSchema),
