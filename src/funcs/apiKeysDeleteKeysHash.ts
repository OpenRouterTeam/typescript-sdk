 ...
 * Delete an API key
 */
export function apiKeysDeleteKeysHash(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteKeysHashRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteKeysHashResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
