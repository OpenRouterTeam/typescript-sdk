...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteBatchRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/batches/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BatchDeletedObject$inboundSchema),
    M.jsonErr([401, 404, 409, 429], errors.BatchErrorResponse$inboundSchema),
