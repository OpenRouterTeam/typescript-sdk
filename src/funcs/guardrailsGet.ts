...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuardrailRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetGuardrailResponse$inboundSchema),
