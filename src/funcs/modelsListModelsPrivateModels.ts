 ...
 * Get a private model
 */
export function modelsListModelsPrivateModels(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListModelsPrivateModelsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/models/private/models/{author}/{slug}")(pathParams);
  ...
  const context = {
    ...
    operationID: "listModelsPrivateModels",
    oAuth2Scopes: null,
