 ...
 */
export function videoGenerationListVideosModels(
  client: OpenRouterCore,
  request?: operations.ListVideosModelsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VideoModelsListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListVideosModelsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VideoModelsListResponse$inboundSchema),
