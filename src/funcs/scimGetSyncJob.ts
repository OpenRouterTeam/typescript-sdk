 ...
 */
export function scimGetSyncJob(
  client: OpenRouterCore,
  request: operations.GetScimSyncJobRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetScimSyncJobResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetScimSyncJobRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetScimSyncJobResponse$inboundSchema),
