...
export function presetsList(
  ...
  PageIterator<
    Result<
      operations.ListPresetsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPresetsRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPresetsResponse$inboundSchema, {
      key: "Result",
    }),
