 ...
 */
export function batchCreateBatches(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateBatchesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.BatchSubmitBody, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.BatchObject$inboundSchema),
    M.jsonErr(
      [400, 401, 402, 403, 404, 413, 422, 429],
      errors.BatchErrorResponse$inboundSchema,
    ),
