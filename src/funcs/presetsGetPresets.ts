 ...
 */
export function presetsGetPresets(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPresetsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPresetsResponse$inboundSchema, { key: "Result" }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "versions");
