 ...
 */
export function batchGetBatches(
  ...
  Result<
    models.BatchObject,
    | errors.BatchPaymentRequiredResponseError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetBatchesRequest$outboundSchema.parse(value),
