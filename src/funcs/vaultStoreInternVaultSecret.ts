 ...
 */
export function vaultStoreInternVaultSecret(
  client: OpenRouterCore,
  request: operations.StoreInternVaultSecretRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VaultSecretResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StoreInternVaultSecretRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VaultSecretResponse$inboundSchema),
