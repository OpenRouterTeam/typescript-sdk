...
export function datasetsGetAppRankings(
  ...
  PageIterator<
    Result<
      operations.GetAppRankingsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAppRankingsRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAppRankingsResponse$inboundSchema, {
      key: "Result",
    }),
