 ...
 */
export function toolsCreateTools(
  client: OpenRouterCore,
  request: operations.CreateToolsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.CreateToolResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateToolsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateToolRequest, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateToolResponse$inboundSchema),
