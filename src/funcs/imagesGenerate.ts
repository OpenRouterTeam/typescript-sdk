...
import { GenerateImageServerList } from "../models/operations/generateimage.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GenerateImageRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GenerateImageServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/api/beta/images")();
