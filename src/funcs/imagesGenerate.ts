...
export function imagesGenerate(
  ...
  request: operations.CreateImagesRequest & {
    imageGenerationRequest: { stream?: false };
  },
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateImagesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateImagesResponse$inboundSchema),
    M.sse(200, operations.CreateImagesResponse$inboundSchema),
