 ...
 */
export function vaultListInternVaultSecrets(
  client: OpenRouterCore,
  request: operations.ListInternVaultSecretsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VaultSecretListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListInternVaultSecretsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VaultSecretListResponse$inboundSchema),
