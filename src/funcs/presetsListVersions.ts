 ...
 */
export function presetsListVersions(
  ...
  PageIterator<
    Result<
      operations.ListPresetVersionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPresetVersionsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPresetVersionsResponse$inboundSchema, {
      key: "Result",
    }),
