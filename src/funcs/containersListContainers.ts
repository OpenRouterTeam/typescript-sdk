 ...
 */
export function containersListContainers(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListContainersRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ContainerListResponse$inboundSchema),
