 ...
 */
export function provisioningProvisionOrganization(
  client: OpenRouterCore,
  request: operations.ProvisionOrganizationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ProvisionOrganizationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ProvisionOrganizationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/provisioning/organizations")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ProvisionOrganizationResponse$inboundSchema),
