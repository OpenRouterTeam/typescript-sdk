...
export function containersListContainerFiles(
  ...
  Result<
    models.ContainerFileListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListContainerFilesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ContainerFileListResponse$inboundSchema),
