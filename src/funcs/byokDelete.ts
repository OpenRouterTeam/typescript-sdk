 ...
 */
export function byokDelete(
  client: OpenRouterCore,
  request: operations.DeleteBYOKKeyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DeleteBYOKKeyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteBYOKKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteBYOKKeyResponse$inboundSchema),
