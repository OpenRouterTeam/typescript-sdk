 ...
 */
export function guardrailsListGuardrailMemberAssignments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGuardrailMemberAssignmentsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ListGuardrailMemberAssignmentsResponse$inboundSchema,
      { key: "Result" },
    ),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      guardrailsListGuardrailMemberAssignments(
        client,
        security,
        {
          ...request,
