 ...
 */
export function vaultCopyVaultSecretsToIntern(
  client: OpenRouterCore,
  request: operations.CopyVaultSecretsToInternRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VaultSecretCopyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CopyVaultSecretsToInternRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VaultSecretCopyResponse$inboundSchema),
