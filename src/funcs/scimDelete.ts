...
export function scimDelete(
  ...
  Result<
    models.DeleteScimGroupMappingResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteScimGroupMappingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteScimGroupMappingResponse$inboundSchema),
