 ...
 */
export function scimUpdate(
  client: OpenRouterCore,
  request: operations.UpdateScimGroupMappingRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.UpdateScimGroupMappingResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateScimGroupMappingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateScimGroupMappingResponse$inboundSchema),
