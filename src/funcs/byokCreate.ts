...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateBYOKKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateBYOKKeyResponse$inboundSchema),
