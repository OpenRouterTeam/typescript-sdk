...
export function workspacesBulkAddMembers(
  ...
  Result<
    models.BulkAddWorkspaceMembersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkAddWorkspaceMembersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/workspaces/{workspace_id}/members/add")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BulkAddWorkspaceMembersResponse$inboundSchema),
