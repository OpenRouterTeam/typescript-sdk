 ...
 */
export function workspacesGetBudget(
  client: OpenRouterCore,
  request: operations.GetWorkspaceBudgetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetWorkspaceBudgetResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWorkspaceBudgetRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/workspaces/{workspace_ref}/budgets/{interval}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetWorkspaceBudgetResponse$inboundSchema),
