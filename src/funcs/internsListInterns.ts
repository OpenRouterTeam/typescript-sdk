 ...
 */
export function internsListInterns(
  client: OpenRouterCore,
  request?: operations.ListInternsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.InternListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListInternsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.InternListResponse$inboundSchema),
    M.jsonErr(
      [400, 401, 403, 404, 408],
