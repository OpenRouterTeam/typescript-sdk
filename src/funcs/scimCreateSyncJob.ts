 ...
 */
export function scimCreateSyncJob(
  client: OpenRouterCore,
  request?: operations.CreateScimSyncJobRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.CreateScimSyncJobResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateScimSyncJobRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.CreateScimSyncJobResponse$inboundSchema),
