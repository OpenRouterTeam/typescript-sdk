 ...
 */
export function internsGetInternDaemonAccess(
  client: OpenRouterCore,
  request: operations.GetInternDaemonAccessRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.InternDaemonAccess,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInternDaemonAccessRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/interns/{internId}/daemon-access")(pathParams);
