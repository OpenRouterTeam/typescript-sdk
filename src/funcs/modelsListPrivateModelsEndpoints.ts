 ...
 */
export function modelsListPrivateModelsEndpoints(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPrivateModelsEndpointsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/private/models/{author}/{slug}/endpoints")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "listPrivateModelsEndpoints",
    oAuth2Scopes: null,
