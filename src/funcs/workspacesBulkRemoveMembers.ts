...
export function workspacesBulkRemoveMembers(
  ...
  Result<
    models.BulkRemoveWorkspaceMembersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkRemoveWorkspaceMembersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BulkRemoveWorkspaceMembersResponse$inboundSchema),
