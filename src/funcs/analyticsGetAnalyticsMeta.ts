 ...
 */
export function analyticsGetAnalyticsMeta(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAnalyticsMetaRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAnalyticsMetaResponse$inboundSchema),
