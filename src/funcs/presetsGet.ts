...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPresetRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPresetResponse$inboundSchema, { key: "Result" }),
