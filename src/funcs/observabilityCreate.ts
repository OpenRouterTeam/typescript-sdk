...
export function observabilityCreate(
  ...
  Result<
    models.CreateObservabilityDestinationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateObservabilityDestinationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.CreateObservabilityDestinationRequest,
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateObservabilityDestinationResponse$inboundSchema),
