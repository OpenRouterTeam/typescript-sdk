 ...
 */
export function creditsGetCurrentBudget(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCurrentBudgetRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BudgetResponse$inboundSchema),
