 ...
 */
export function internsGetIntern(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetInternRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr([401, 403, 404, 408], errors.InternLifecycleError$inboundSchema),
