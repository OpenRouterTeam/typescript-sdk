 ...
 */
export function internsSuspendIntern(
  client: OpenRouterCore,
  request: operations.SuspendInternRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.SuspendInternResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SuspendInternRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SuspendInternResponse$inboundSchema),
    M.jsonErr(
      [401, 403, 404, 408, 409],
