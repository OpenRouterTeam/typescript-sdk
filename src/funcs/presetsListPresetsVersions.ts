 ...
 */
export function presetsListPresetsVersions(
  client: OpenRouterCore,
  request: operations.ListPresetsVersionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetPresetVersionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPresetsVersionsRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "listPresetsVersions",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPresetVersionResponse$inboundSchema),
