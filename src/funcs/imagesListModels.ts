 ...
 */
export function imagesListModels(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListImageModelsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ImageModelsListResponse$inboundSchema),
