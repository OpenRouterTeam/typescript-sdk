...
export type CreateWorkspaceRequest = {
   ...
   */
  isBroadcastEnabled?: boolean | undefined;
  /**
   ...
   */
  isPrivateLoggingEnabled?: boolean | undefined;
  /**
...
export type CreateWorkspaceRequest$Outbound = {
  ...
  description?: string | null | undefined;
  is_broadcast_enabled?: boolean | undefined;
  is_data_discount_logging_enabled?: boolean | undefined;
  is_private_logging_enabled?: boolean | undefined;
  name: string;
  slug: string;
};
...
> = z.object({
  ...
  isPrivateLoggingEnabled: z.boolean().optional(),
  name: z.string(),
  slug: z.string(),
}).transform((v) => {
  return remap$(v, {
    ...
    isPrivateLoggingEnabled: "is_private_logging_enabled",
  });
});
