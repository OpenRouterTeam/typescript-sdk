...
export type ResponsesRequest = {
  ...
  /**
   * Whether to store the response. Only honored on BYOK endpoints, where the request is sent with the user's own provider key. Ignored on non-BYOK routing and sent upstream with `store: false`.
   */
