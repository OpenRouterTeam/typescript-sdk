...
export type UpdateBYOKKeyRequest = {
  /**
   * Optional allowlist of OpenRouter API key hashes (`api_keys.hash`) that may use this credential. `null` clears the restriction. Hashes that do not belong to your account return a 400.
   */
