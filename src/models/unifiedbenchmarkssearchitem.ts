...
export type Metrics = {
  ...
  accuracy: number;
  /**
   * Item-weighted partial-credit F1. Only populated for benchmarks that score partial credit (WideSearch); null otherwise.
   */
...
export type UnifiedBenchmarksSearchItem = {
  ...
  /**
   * The benchmark's headline score from 0 to 1. Higher is better.
   */
  primaryScore: number;
  /**
