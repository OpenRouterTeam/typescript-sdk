...
/** @internal */
export const EdgeNetworkTimeoutResponseError$outboundSchema: z.ZodType<
  EdgeNetworkTimeoutResponseError$Outbound,
  EdgeNetworkTimeoutResponseError
> = z.custom<EdgeNetworkTimeoutResponseError>(x =>
  x instanceof EdgeNetworkTimeoutResponseError
)
  .transform(v => v.data$)
  .pipe(
    z.object({
 ...
 */
export namespace EdgeNetworkTimeoutResponseError$ {
  /** @deprecated use `EdgeNetworkTimeoutResponseError$inboundSchema` instead. */
  export const inboundSchema = EdgeNetworkTimeoutResponseError$inboundSchema;
  /** @deprecated use `EdgeNetworkTimeoutResponseError$outboundSchema` instead. */
  export const outboundSchema = EdgeNetworkTimeoutResponseError$outboundSchema;
  /** @deprecated use `EdgeNetworkTimeoutResponseError$Outbound` instead. */
  export type Outbound = EdgeNetworkTimeoutResponseError$Outbound;
}
