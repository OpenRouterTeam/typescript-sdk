...
export type ModelReasoning = {
  ...
  mandatory: boolean;
  /**
   * Allowed reasoning effort values for this model. Null means no allowlist — all gateway effort values are accepted.
   */
  supportedEfforts?: Array<ReasoningEffort | null> | null | undefined;
  /**
   * When true, the model accepts `reasoning.max_tokens` in requests (Anthropic-style) instead of or in addition to `reasoning.effort`.
   */
