...
export const InputsTypeFunction = {
  Function: "function",
} as const;
export type InputsTypeFunction = ClosedEnum<typeof InputsTypeFunction>;

/**
 * Function tool definition
 */
export type InputsToolFunction = {
  description?: string | null | undefined;
  name: string;
  parameters: { [k: string]: any } | null;
  strict?: boolean | null | undefined;
  type: InputsTypeFunction;
};
...
export const TypeToolSearchCall = {
  ToolSearchCall: "tool_search_call",
} as const;
export type TypeToolSearchCall = ClosedEnum<typeof TypeToolSearchCall>;
...
/** @internal */
export const InputsTypeFunction$outboundSchema: z.ZodEnum<
  typeof InputsTypeFunction
> = z.enum(InputsTypeFunction);

/** @internal */
export type InputsToolFunction$Outbound = {
  description?: string | null | undefined;
  name: string;
  parameters: { [k: string]: any } | null;
  strict?: boolean | null | undefined;
...
/** @internal */
export const InputsToolFunction$outboundSchema: z.ZodType<
  InputsToolFunction$Outbound,
  InputsToolFunction
> = z.object({
  ...
  type: InputsTypeFunction$outboundSchema,
});

export function inputsToolFunctionToJSON(
  inputsToolFunction: InputsToolFunction,
): string {
  return JSON.stringify(
    InputsToolFunction$outboundSchema.parse(inputsToolFunction),
  );
}
...
> = z.union([
  ComputerUseServerTool$outboundSchema,
  NamespaceTool$outboundSchema,
  z.lazy(() => InputsToolFunction$outboundSchema),
  FileSearchServerTool$outboundSchema,
  CodeInterpreterServerTool$outboundSchema,
  McpServerTool$outboundSchema,
  CustomTool$outboundSchema,
...
/** @internal */
export const TypeToolSearchCall$outboundSchema: z.ZodEnum<
  typeof TypeToolSearchCall
> = z.enum(TypeToolSearchCall);
...
> = z.object({
  ...
  type: TypeToolSearchCall$outboundSchema,
  additionalProperties: z.record(z.string(), z.any()).optional(),
}).transform((v) => {
  return {
    ...v.additionalProperties,
