...
export type SubagentServerToolConfig = {
  ...
  /**
   * Tools the subagent may use while executing a delegated task. The subagent runs as an agentic sub-agent over these tools, then returns its outcome. Must not include the subagent tool itself.
   */
