...
export type SubagentServerToolConfig = {
  /**
   * Names of client functions defined in the request top-level `tools` list. When the child calls one, OpenRouter suspends the subagent and returns a normal outer `function_call` item attributed to it via `subagent_id`.
   */
