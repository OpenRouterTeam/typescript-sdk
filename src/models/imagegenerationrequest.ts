...
export type ImageGenerationRequest = {
  ...
  /**
   * Reference images to guide image-to-image generation, as base64 data URLs or HTTP(S) URLs. Each fetched or decoded image must be 30 MB or smaller.
   */
  ...
  n?: number | undefined;
  /**
   * Compression level (0-100) for webp/jpeg output. Use only with compressible output formats.
   */
  ...
  /**
   * Requested output size, passed through to the provider (e.g. "2K", "4K", "2048x2048"). Explicit pixel sizes may conflict with resolution or aspect_ratio.
   */
