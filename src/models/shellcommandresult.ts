...
/** @internal */
export const ShellCommandResult$inboundSchema: z.ZodType<
  ShellCommandResult,
  unknown
> = z.object({
...
/** @internal */
export type ShellCommandResult$Outbound = {
...
/** @internal */
export const ShellCommandResult$outboundSchema: z.ZodType<
...
export function shellCommandResultToJSON(
  shellCommandResult: ShellCommandResult,
): string {
  return JSON.stringify(
    ShellCommandResult$outboundSchema.parse(shellCommandResult),
  );
}
export function shellCommandResultFromJSON(
  jsonString: string,
): SafeParseResult<ShellCommandResult, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ShellCommandResult$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ShellCommandResult' from JSON`,
  );
}
