...
export type OutputSubagentServerToolItem = {
  /**
   * The `call_id` of the tool call that spawned this subagent. Matches the `subagent_id` on `function_call` items the subagent projected, so a replayed conversation pairs a suspended subagent with its pending client calls.
   */
