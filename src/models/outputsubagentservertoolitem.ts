...
import {
  ...
  SubagentContinuationV1$inboundSchema,
  SubagentContinuationV1$Outbound,
  SubagentContinuationV1$outboundSchema,
} from "./subagentcontinuationv1.js";
import {
  ToolCallStatus,
...
export type OutputSubagentServerToolItem = {
   ...
   */
  continuation?: SubagentContinuationV1 | undefined;
  /**
...
> = z.object({
  ...
  continuation: SubagentContinuationV1$inboundSchema.optional(),
...
export type OutputSubagentServerToolItem$Outbound = {
  ...
  continuation?: SubagentContinuationV1$Outbound | undefined;
  error?: string | undefined;
  id?: string | undefined;
...
> = z.object({
  ...
  continuation: SubagentContinuationV1$outboundSchema.optional(),
  error: z.string().optional(),
  id: z.string().optional(),
