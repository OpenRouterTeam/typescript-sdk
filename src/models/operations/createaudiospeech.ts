 ...
 */
export type CreateAudioSpeechRequestBody = {
  /**
   * Text to synthesize
   */
  input: string;
...
export type CreateAudioSpeechRequest = {
   ...
   */
  appCategories?: string | undefined;
  requestBody: CreateAudioSpeechRequestBody;
};
...
/** @internal */
export type CreateAudioSpeechRequestBody$Outbound = {
  input: string;
  model: string;
...
/** @internal */
export const CreateAudioSpeechRequestBody$outboundSchema: z.ZodType<
  CreateAudioSpeechRequestBody$Outbound,
...
export function createAudioSpeechRequestBodyToJSON(
  createAudioSpeechRequestBody: CreateAudioSpeechRequestBody,
): string {
  return JSON.stringify(
    CreateAudioSpeechRequestBody$outboundSchema.parse(
      createAudioSpeechRequestBody,
    ),
  );
}
...
export type CreateAudioSpeechRequest$Outbound = {
  ...
  appTitle?: string | undefined;
  appCategories?: string | undefined;
  RequestBody: CreateAudioSpeechRequestBody$Outbound;
};
...
> = z.object({
  ...
  requestBody: z.lazy(() => CreateAudioSpeechRequestBody$outboundSchema),
}).transform((v) => {
  return remap$(v, {
