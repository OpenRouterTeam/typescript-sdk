...
export type ListAgentsRequest = {
  ...
  /**
   * Filter by underlying adapter.
   */
  adapter?: models.AgentSlug | undefined;
  /**
...
> = z.object({
  ...
  adapter: models.AgentSlug$outboundSchema.optional(),
...
export const ListAgentsResponse$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  Result: models.ListAgentsResponse$inboundSchema,
}).transform((v) => {
  return remap$(v, {
    "Result": "result",
  });
