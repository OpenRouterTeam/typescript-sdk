...
export type CreateKeysRequestBody = {
  ...
  /**
   * Optional partner-supplied API key with a minimum length of 32 characters and sufficient entropy. It must be generated exclusively for OpenRouter and never be a credential shared with or issued by another system. Stored as a SHA-256 hash and never returned. Can be presented as a bearer credential. Accepted only when authenticating with a Connect client secret; supplying it with a management key is rejected with 403.
   */
