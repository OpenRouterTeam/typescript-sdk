...
export type CreateKeysRequestBody = {
  ...
  /**
   * Optional partner credential to associate with the new API key. It requires client credential authentication using a client ID and secret, must be between 1 and 512 characters, is stored only as a SHA-256 hash, and is never returned.
   */
  externalApiKey?: string | undefined;
  /**
   * Optional partner's end-user identifier for attribution. It requires client credential authentication using a client ID and secret, and must be between 1 and 512 characters.
   */
...
export const CreateKeysData$inboundSchema: z.ZodType<CreateKeysData, unknown> =
  z.object({
    ...
    external_user_id: z.nullable(z.string()),
    hash: z.string(),
