...
export type CreateKeysRequestBody = {
  ...
  /**
   * Optional partner credential to associate with the new API key. It must be between 1 and 512 characters, is stored only as a SHA-256 hash, and is never returned.
   */
