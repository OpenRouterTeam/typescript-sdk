...
/** @internal */
export const Headquarters$inboundSchema: z.ZodType<Headquarters, unknown> =
  openEnums.inboundSchema(Headquarters);

/** @internal */
export const Datacenter$inboundSchema: z.ZodType<Datacenter, unknown> =
  openEnums.inboundSchema(Datacenter);
...
> = z.object({
  ...
  headquarters: z.nullable(Headquarters$inboundSchema).optional(),
  datacenters: z.nullable(z.array(Datacenter$inboundSchema)).optional(),
}).transform((v) => {
  return remap$(v, {
