...
/** @internal */
export const StoreInternVaultSecretRequest$outboundSchema: z.ZodType<
  StoreInternVaultSecretRequest$Outbound,
...
export function storeInternVaultSecretRequestToJSON(
  storeInternVaultSecretRequest: StoreInternVaultSecretRequest,
): string {
  return JSON.stringify(
    StoreInternVaultSecretRequest$outboundSchema.parse(
      storeInternVaultSecretRequest,
    ),
  );
}
