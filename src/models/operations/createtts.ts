...
/** @internal */
export const CreateTtsRequestBody$outboundSchema: z.ZodType<
  CreateTtsRequestBody$Outbound,
...
export function createTtsRequestBodyToJSON(
  createTtsRequestBody: CreateTtsRequestBody,
): string {
  return JSON.stringify(
    CreateTtsRequestBody$outboundSchema.parse(createTtsRequestBody),
  );
}
...
/** @internal */
export const CreateTtsRequest$outboundSchema: z.ZodType<
  CreateTtsRequest$Outbound,
  CreateTtsRequest
> = z.object({
...
export function createTtsRequestToJSON(
  createTtsRequest: CreateTtsRequest,
): string {
  return JSON.stringify(
    CreateTtsRequest$outboundSchema.parse(createTtsRequest),
  );
}

/** @internal */
export const CreateTtsResponse$inboundSchema: z.ZodType<
  CreateTtsResponse,
  unknown
> = z.union([
...
export function createTtsResponseFromJSON(
  jsonString: string,
): SafeParseResult<CreateTtsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateTtsResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateTtsResponse' from JSON`,
  );
}
