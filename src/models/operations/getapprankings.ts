 ...
 */
export const GetAppRankingsSort = {
  Popular: "popular",
  Trending: "trending",
} as const;
/**
...
/** @internal */
export const GetAppRankingsSort$outboundSchema: z.ZodType<
  string,
  GetAppRankingsSort
> = openEnums.outboundSchema(GetAppRankingsSort);
...
> = z.object({
  ...
  sort: GetAppRankingsSort$outboundSchema.default("popular"),
