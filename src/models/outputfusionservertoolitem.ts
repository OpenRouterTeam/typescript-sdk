...
export type OutputFusionServerToolItem = {
  ...
  /**
   * Models that were requested as part of the analysis panel but did not produce a response. Only present when `is_partial` is true.
   */
  failedModels?: Array<FailedModel> | undefined;
  id?: string | undefined;
  /**
   * True when at least one requested analysis model failed to respond. The fusion result is still usable but was produced from a degraded panel.
   */
