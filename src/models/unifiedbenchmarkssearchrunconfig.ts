...
export type UnifiedBenchmarksSearchRunConfig = {
  ...
  /**
   * Maximum search results returned per search call, or null when the lane used the server default or resolved to native provider search.
   */
  maxResults?: number | null | undefined;
  /**
   * Maximum cumulative search results across all search calls in one benchmark task/request, or null when omitted or unsupported by the surface or resolved engine.
   */
