...
/** @internal */
export const RefusalContentType$inboundSchema: z.ZodNativeEnum<
  typeof RefusalContentType
> = z.nativeEnum(RefusalContentType);

/** @internal */
export const RefusalContentType$outboundSchema: z.ZodNativeEnum<
  typeof RefusalContentType
...
/** @internal */
export const RefusalContent$inboundSchema: z.ZodType<
  RefusalContent,
  z.ZodTypeDef,
  unknown
> = z.object({
