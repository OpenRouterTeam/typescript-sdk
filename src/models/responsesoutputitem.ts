...
export const ResponsesOutputItemTypeImageGenerationCall$inboundSchema:
  z.ZodEnum<typeof ResponsesOutputItemTypeImageGenerationCall> = z.enum(
    ResponsesOutputItemTypeImageGenerationCall,
  );

/** @internal */
export const ResponsesOutputItemTypeImageGenerationCall$outboundSchema:
  z.ZodEnum<typeof ResponsesOutputItemTypeImageGenerationCall> =
...
/** @internal */
export const ResponsesOutputItemTypeFileSearchCall$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeFileSearchCall
> = z.enum(ResponsesOutputItemTypeFileSearchCall);

/** @internal */
export const ResponsesOutputItemTypeFileSearchCall$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeFileSearchCall
...
/** @internal */
export const ResponsesOutputItemTypeWebSearchCall$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeWebSearchCall
> = z.enum(ResponsesOutputItemTypeWebSearchCall);

/** @internal */
export const ResponsesOutputItemTypeWebSearchCall$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeWebSearchCall
...
/** @internal */
export const ResponsesOutputItemTypeFunctionCall$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeFunctionCall
> = z.enum(ResponsesOutputItemTypeFunctionCall);

/** @internal */
export const ResponsesOutputItemTypeFunctionCall$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeFunctionCall
...
/** @internal */
export const ResponsesOutputItemTypeReasoning$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeReasoning
> = z.enum(ResponsesOutputItemTypeReasoning);

/** @internal */
export const ResponsesOutputItemTypeReasoning$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeReasoning
...
/** @internal */
export const ResponsesOutputItemRole$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemRole
> = z.enum(ResponsesOutputItemRole);

/** @internal */
export const ResponsesOutputItemRole$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemRole
...
/** @internal */
export const ResponsesOutputItemTypeMessage$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeMessage
> = z.enum(ResponsesOutputItemTypeMessage);

/** @internal */
export const ResponsesOutputItemTypeMessage$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemTypeMessage
...
/** @internal */
export const ResponsesOutputItemStatusInProgress$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemStatusInProgress
> = z.enum(ResponsesOutputItemStatusInProgress);

/** @internal */
export const ResponsesOutputItemStatusInProgress$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemStatusInProgress
...
/** @internal */
export const ResponsesOutputItemStatusIncomplete$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemStatusIncomplete
> = z.enum(ResponsesOutputItemStatusIncomplete);

/** @internal */
export const ResponsesOutputItemStatusIncomplete$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemStatusIncomplete
...
/** @internal */
export const ResponsesOutputItemStatusCompleted$inboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemStatusCompleted
> = z.enum(ResponsesOutputItemStatusCompleted);

/** @internal */
export const ResponsesOutputItemStatusCompleted$outboundSchema: z.ZodEnum<
  typeof ResponsesOutputItemStatusCompleted
