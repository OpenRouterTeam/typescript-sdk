...
/** @internal */
export const OpenResponsesImageGenerationTool$inboundSchema: z.ZodType<
...
/** @internal */
export const OpenResponsesImageGenerationTool$outboundSchema: z.ZodType<
...
export function openResponsesImageGenerationToolToJSON(
  openResponsesImageGenerationTool: OpenResponsesImageGenerationTool,
): string {
  return JSON.stringify(
    OpenResponsesImageGenerationTool$outboundSchema.parse(
      openResponsesImageGenerationTool,
    ),
  );
}
export function openResponsesImageGenerationToolFromJSON(
  jsonString: string,
): SafeParseResult<OpenResponsesImageGenerationTool, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => OpenResponsesImageGenerationTool$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OpenResponsesImageGenerationTool' from JSON`,
  );
}
