 ...
 */
export const WebSearchConfigEngine = {
  Auto: "auto",
  Native: "native",
  Exa: "exa",
  Firecrawl: "firecrawl",
 ...
 * Which search engine to use. "auto" (default) uses native if the provider supports it, otherwise Exa. "native" forces the provider's built-in search. "exa" forces the Exa search API. "firecrawl" uses Firecrawl (requires BYOK). "parallel" uses the Parallel search API.
 */
export type WebSearchConfigEngine = OpenEnum<typeof WebSearchConfigEngine>;

export type WebSearchConfig = {
  /**
   * Which search engine to use. "auto" (default) uses native if the provider supports it, otherwise Exa. "native" forces the provider's built-in search. "exa" forces the Exa search API. "firecrawl" uses Firecrawl (requires BYOK). "parallel" uses the Parallel search API.
   */
  engine?: WebSearchConfigEngine | undefined;
  /**
...
/** @internal */
export const WebSearchConfigEngine$outboundSchema: z.ZodType<
  string,
  WebSearchConfigEngine
> = openEnums.outboundSchema(WebSearchConfigEngine);
...
export const WebSearchConfig$outboundSchema: z.ZodType<
  ...
  WebSearchConfig
> = z.object({
  engine: WebSearchConfigEngine$outboundSchema.optional(),
