 ...
 */
export const WebSearchConfigMode = {
  Turbo: "turbo",
  Basic: "basic",
  Advanced: "advanced",
} as const;
 ...
 * Engine-specific search mode. Currently supported for the Parallel engine: turbo (~200 ms, $1/1k requests, English and Japanese), basic (~1 s, $5/1k, default), or advanced (~3 s, $5/1k). Rejected when the selected engine doesn't offer the given mode.
 */
export type WebSearchConfigMode = OpenEnum<typeof WebSearchConfigMode>;
...
export type WebSearchConfig = {
   ...
   * Engine-specific search mode. Currently supported for the Parallel engine: turbo (~200 ms, $1/1k requests, English and Japanese), basic (~1 s, $5/1k, default), or advanced (~3 s, $5/1k). Rejected when the selected engine doesn't offer the given mode.
   */
  mode?: WebSearchConfigMode | undefined;
  /**
...
/** @internal */
export const WebSearchConfigMode$outboundSchema: z.ZodType<
  string,
  WebSearchConfigMode
> = openEnums.outboundSchema(WebSearchConfigMode);
...
> = z.object({
  ...
  mode: WebSearchConfigMode$outboundSchema.optional(),
