 ...
 * The primary use-case category (chat, reasoning, code, creative, image, tts, stt, video, embedding)
 */
export type ChatRequestTask = OpenEnum<typeof ChatRequestTask>;

/**
 * The optimization axis for routing (fast, smart, latest, high, precise, cheap)
 */
export const ChatRequestConstraint = {
  Fast: "fast",
  Smart: "smart",
  Latest: "latest",
  High: "high",
 ...
 * The optimization axis for routing (fast, smart, latest, high, precise, cheap)
 */
export type ChatRequestConstraint = OpenEnum<typeof ChatRequestConstraint>;

/**
 * Optional quality/cost tier (free, standard, premium)
 */
export const ChatRequestTier = {
  Free: "free",
  Standard: "standard",
  Premium: "premium",
} as const;
 ...
 * Optional quality/cost tier (free, standard, premium)
 */
export type ChatRequestTier = OpenEnum<typeof ChatRequestTier>;
...
export type ChatRequestIntent = {
   ...
   * The optimization axis for routing (fast, smart, latest, high, precise, cheap)
   */
  constraint: ChatRequestConstraint;
  /**
   * Optional quality/cost tier (free, standard, premium)
   */
  tier?: ChatRequestTier | null | undefined;
};
 ...
 */
export const ChatRequestStrategy = {
 ...
 * The selection strategy to apply among filtered candidates (latency-first, quality-first, cost-first, balanced)
 */
export type ChatRequestStrategy = OpenEnum<typeof ChatRequestStrategy>;
 ...
 */
export type ChatRequestRouting = {
  /**
   * The routing intent specifying task and optimization constraint
   */
   ...
   * Filters to narrow the candidate model set
   */
  filters?: ChatRequestFilters | undefined;
  /**
   * The selection strategy to apply among filtered candidates (latency-first, quality-first, cost-first, balanced)
   */
  strategy?: ChatRequestStrategy | null | undefined;
};
...
export type ChatRequestPluginAutoRouter = {
   ...
   * Composable routing intent configuration. Alternative to using composable slug syntax (e.g. auto/chat.fast). Currently used alongside slug-based intent resolution.
   */
  routing?: ChatRequestRouting | undefined;
};
...
export type ChatRequest = {
  ...
  /**
   * Model to use for completion. Accepts a specific model slug (e.g. "openai/gpt-4o"), a legacy auto-router slug (e.g. "auto/fast", "auto/smart"), or a composable auto-router slug using the grammar: auto/<task>.<constraint>[.<tier>]. Tasks: chat, reasoning, code, creative, image, tts, stt, video, embedding. Examples: "auto/chat.fast", "auto/reasoning.high", "auto/image.smart", "auto/tts.fast", "auto/video.fast". Provider/family filtering is handled via the routing.filters field in the request body.
   */
...
/** @internal */
export const ChatRequestTask$outboundSchema: z.ZodType<
  string,
  ChatRequestTask
> = openEnums.outboundSchema(ChatRequestTask);

/** @internal */
export const ChatRequestConstraint$outboundSchema: z.ZodType<
  string,
  ChatRequestConstraint
> = openEnums.outboundSchema(ChatRequestConstraint);

/** @internal */
export const ChatRequestTier$outboundSchema: z.ZodType<
  string,
  ChatRequestTier
> = openEnums.outboundSchema(ChatRequestTier);

/** @internal */
export type ChatRequestIntent$Outbound = {
  task: string;
  constraint: string;
...
/** @internal */
export const ChatRequestIntent$outboundSchema: z.ZodType<
  ChatRequestIntent$Outbound,
  ChatRequestIntent
> = z.object({
  task: ChatRequestTask$outboundSchema,
  constraint: ChatRequestConstraint$outboundSchema,
  tier: z.nullable(ChatRequestTier$outboundSchema).optional(),
});

export function chatRequestIntentToJSON(
  chatRequestIntent: ChatRequestIntent,
): string {
  return JSON.stringify(
    ChatRequestIntent$outboundSchema.parse(chatRequestIntent),
  );
}

/** @internal */
export type ChatRequestFilters$Outbound = {
  provider?: Array<string> | undefined;
  family?: Array<string> | undefined;
  capabilities?: Array<string> | undefined;
};
...
/** @internal */
export const ChatRequestFilters$outboundSchema: z.ZodType<
  ChatRequestFilters$Outbound,
  ChatRequestFilters
> = z.object({
...
export function chatRequestFiltersToJSON(
  chatRequestFilters: ChatRequestFilters,
): string {
  return JSON.stringify(
    ChatRequestFilters$outboundSchema.parse(chatRequestFilters),
  );
}

/** @internal */
export const ChatRequestStrategy$outboundSchema: z.ZodType<
  string,
  ChatRequestStrategy
> = openEnums.outboundSchema(ChatRequestStrategy);

/** @internal */
export type ChatRequestRouting$Outbound = {
  intent: ChatRequestIntent$Outbound;
  filters?: ChatRequestFilters$Outbound | undefined;
  strategy?: string | null | undefined;
};

/** @internal */
export const ChatRequestRouting$outboundSchema: z.ZodType<
  ChatRequestRouting$Outbound,
  ChatRequestRouting
> = z.object({
  intent: z.lazy(() => ChatRequestIntent$outboundSchema),
  filters: z.lazy(() => ChatRequestFilters$outboundSchema).optional(),
  strategy: z.nullable(ChatRequestStrategy$outboundSchema).optional(),
});

export function chatRequestRoutingToJSON(
  chatRequestRouting: ChatRequestRouting,
): string {
  return JSON.stringify(
    ChatRequestRouting$outboundSchema.parse(chatRequestRouting),
  );
}
...
export type ChatRequestPluginAutoRouter$Outbound = {
  ...
  routing?: ChatRequestRouting$Outbound | undefined;
};
...
> = z.object({
  ...
  routing: z.lazy(() => ChatRequestRouting$outboundSchema).optional(),
}).transform((v) => {
  return remap$(v, {
