...
export type ChatRequestPluginPromptInjection = {
  id: "prompt-injection";
  /**
...
/** @internal */
export type ChatRequestPluginPromptInjection$Outbound = {
  id: "prompt-injection";
  mode?: string | undefined;
};

/** @internal */
export const ChatRequestPluginPromptInjection$outboundSchema: z.ZodType<
  ChatRequestPluginPromptInjection$Outbound,
  ChatRequestPluginPromptInjection
> = z.object({
...
export function chatRequestPluginPromptInjectionToJSON(
  chatRequestPluginPromptInjection: ChatRequestPluginPromptInjection,
): string {
  return JSON.stringify(
    ChatRequestPluginPromptInjection$outboundSchema.parse(
      chatRequestPluginPromptInjection,
    ),
  );
}
...
> = z.union([
  ...
  z.lazy(() => ChatRequestPluginPromptInjection$outboundSchema),
]);
