...
export type ChatRequest = {
  ...
  /**
   * Cache-routing key forwarded to OpenAI to improve prompt cache hit rates for requests sharing a prompt prefix. Only supported by OpenAI GPT-5.6 and newer.
   */
