...
/** @internal */
export const SpeechRequestOptions$outboundSchema: z.ZodType<
  SpeechRequestOptions$Outbound,
...
export function speechRequestOptionsToJSON(
  speechRequestOptions: SpeechRequestOptions,
): string {
  return JSON.stringify(
    SpeechRequestOptions$outboundSchema.parse(speechRequestOptions),
  );
}
