...
export type SpeechRequest = {
  ...
  /**
   * Base64-encoded reference audio (optionally a data URI) for stateless voice cloning. Only routed to endpoints that support voice cloning. Supported audio formats are provider-specific. Limited to 20 MiB of base64 (15 MiB of decoded audio).
   */
  refAudio?: string | undefined;
  /**
   * Transcript of the reference audio. Optional, but improves voice cloning quality on providers that use it. Requires `ref_audio`.
   */
