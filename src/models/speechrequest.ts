...
export type SpeechRequest = {
  ...
  /**
   * Base64-encoded reference audio (optionally a data URI) for stateless voice cloning. Only routed to endpoints that support voice cloning. Supported audio formats are provider-specific. Limited to ~15 MiB of decoded audio.
   */
