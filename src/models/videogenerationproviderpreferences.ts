...
export type VideoGenerationProviderPreferencesOnly = ProviderName | string;
 ...
 */
export type VideoGenerationProviderPreferencesOptions = {
...
/**
 * Provider routing preferences and provider-specific passthrough configuration. `allow_fallbacks: false` restricts routing to a single provider from the allowed candidates; combine it with a single-entry `only` to pin a specific provider.
 */
export type VideoGenerationProviderPreferences = {
  /**
  ...
  options?: VideoGenerationProviderPreferencesOptions | undefined;
};

/** @internal */
export type VideoGenerationProviderPreferencesOnly$Outbound = string | string;

/** @internal */
export const VideoGenerationProviderPreferencesOnly$outboundSchema: z.ZodType<
  VideoGenerationProviderPreferencesOnly$Outbound,
  VideoGenerationProviderPreferencesOnly
> = z.union([ProviderName$outboundSchema, z.string()]);

export function videoGenerationProviderPreferencesOnlyToJSON(
  videoGenerationProviderPreferencesOnly:
    VideoGenerationProviderPreferencesOnly,
): string {
  return JSON.stringify(
    VideoGenerationProviderPreferencesOnly$outboundSchema.parse(
      videoGenerationProviderPreferencesOnly,
    ),
  );
}
...
/** @internal */
export type VideoGenerationProviderPreferencesOptions$Outbound = {
...
/** @internal */
export const VideoGenerationProviderPreferencesOptions$outboundSchema:
  z.ZodType<
    VideoGenerationProviderPreferencesOptions$Outbound,
    VideoGenerationProviderPreferencesOptions
  > = z.object({
...
export function videoGenerationProviderPreferencesOptionsToJSON(
  videoGenerationProviderPreferencesOptions:
    VideoGenerationProviderPreferencesOptions,
): string {
  return JSON.stringify(
    VideoGenerationProviderPreferencesOptions$outboundSchema.parse(
      videoGenerationProviderPreferencesOptions,
    ),
  );
}
...
/** @internal */
export type VideoGenerationProviderPreferences$Outbound = {
  allow_fallbacks?: boolean | null | undefined;
  only?: Array<string | string> | null | undefined;
  options?: VideoGenerationProviderPreferencesOptions$Outbound | undefined;
};

/** @internal */
export const VideoGenerationProviderPreferences$outboundSchema: z.ZodType<
  VideoGenerationProviderPreferences$Outbound,
  VideoGenerationProviderPreferences
> = z.object({
  allowFallbacks: z.nullable(z.boolean()).optional(),
  only: z.nullable(z.array(z.union([ProviderName$outboundSchema, z.string()])))
    .optional(),
  options: z.lazy(() =>
    VideoGenerationProviderPreferencesOptions$outboundSchema
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
export function videoGenerationProviderPreferencesToJSON(
  videoGenerationProviderPreferences: VideoGenerationProviderPreferences,
): string {
  return JSON.stringify(
    VideoGenerationProviderPreferences$outboundSchema.parse(
      videoGenerationProviderPreferences,
    ),
  );
}
