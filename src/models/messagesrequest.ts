...
export type MessagesRequest = {
  ...
  /**
   * Fallback models to try if the primary model fails or refuses, in order. Handled by OpenRouter multi-model routing rather than Anthropic server-side fallbacks; cannot be combined with `models`. Each entry accepts only `model`.
   */
...
/** @internal */
export const MessagesRequestTool$outboundSchema: z.ZodType<
...
export function messagesRequestToolToJSON(
  messagesRequestTool: MessagesRequestTool,
): string {
  return JSON.stringify(
    MessagesRequestTool$outboundSchema.parse(messagesRequestTool),
  );
}
...
/** @internal */
export const TypeAdvisor20260301$outboundSchema: z.ZodEnum<
  typeof TypeAdvisor20260301
> = z.enum(TypeAdvisor20260301);
...
/** @internal */
export const ToolAdvisor20260301$outboundSchema: z.ZodType<
...
export function toolAdvisor20260301ToJSON(
  toolAdvisor20260301: ToolAdvisor20260301,
): string {
  return JSON.stringify(
    ToolAdvisor20260301$outboundSchema.parse(toolAdvisor20260301),
  );
}
