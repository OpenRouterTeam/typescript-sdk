...
export type MessagesRequest = {
  ...
  /**
   * Fallback models to try if the primary model fails or refuses, in order. Mapped to OpenRouter multi-model routing; cannot be combined with `models`. Each entry accepts only `model`.
   */
