...
export type ChatWebSearchShorthand = {
  /**
   * Limit search results to these domains. Supported by Exa, Firecrawl, Parallel, and most native providers (Anthropic, OpenAI, xAI). Not supported with Perplexity. Firecrawl does not support using both allowed_domains and excluded_domains at once.
   */
  ...
  /**
   * Exclude search results from these domains. Supported by Exa, Firecrawl, Parallel, Anthropic, and xAI. Not supported with OpenAI (silently ignored) or Perplexity. Firecrawl does not support using both allowed_domains and excluded_domains at once.
   */
