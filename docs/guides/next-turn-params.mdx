---
title: nextTurnParams
subtitle: Tool-driven context injection for skills, plugins, and adaptive behavior
headline: 'nextTurnParams | OpenRouter SDK'
canonical-url: https://openrouter.ai/docs/guides/next-turn-params
og:site_name: OpenRouter Documentation
og:title: 'nextTurnParams - OpenRouter SDK'
og:description: 'Build encapsulated, context-aware tools with nextTurnParams. Create skills systems, plugins, and adaptive multi-turn agents.'
og:image: https://openrouter.ai/dynamic-og?title=nextTurnParams&description=Tool-Driven%20Context%20Injection
og:image:width: 1200
og:image:height: 630
...
`nextTurnParams` enables tools to modify conversation context for subsequent turns. This powerful feature allows you to build encapsulated tools that manage their own context - perfect for skills systems, plugins, and adaptive agents.
...
| `maxTokens` | `number \| undefined` | Current max tokens |
| And all other `CallModelInput` properties... |

## Modifiable Parameters

You can modify any `CallModelInput` parameter:
...
nextTurnParams: {
  ...
  // Change model
  model: (params, ctx) => 'anthropic/claude-sonnet-4',
...
- **[Skills Loader Example](/docs/guides/examples/skills-loader)** - Complete implementation
- **[Dynamic Parameters](/docs/guides/dynamic-parameters)** - Async parameter functions
- **[Stop Conditions](/docs/guides/stop-conditions)** - Execution control
