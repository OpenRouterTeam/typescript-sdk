...
subtitle: Convert between OpenAI chat and Anthropic Claude message formats
headline: 'Message Formats | OpenRouter SDK'
canonical-url: https://openrouter.ai/docs/guides/message-formats
og:site_name: OpenRouter Documentation
og:title: 'Message Formats - OpenRouter SDK'
og:description: 'Convert between OpenAI chat format, Anthropic Claude format, and OpenResponses format. Easy migration from other SDKs.'
og:image: https://openrouter.ai/dynamic-og?title=Message%20Formats&description=Format%20Conversion%20Helpers
og:image:width: 1200
og:image:height: 630
...
- **[Text Generation](/docs/guides/text-generation)** - Input formats and parameters
- **[Tools](/docs/guides/tools)** - Add tool capabilities
- **[Streaming](/docs/guides/streaming)** - Stream format-converted responses
