...
* [getPresets](#getpresets) - Get a preset with paginated versions
...
* [listPresetsVersions](#listpresetsversions) - Get a specific version of a preset
...
<!-- UsageSnippet language="typescript" operationID="getPresets" method="get" path="/presets/{slug}" -->
```typescript
...
async function run() {
  const result = await openRouter.presets.getPresets({
    slug: "my-preset",
  });
...
import { presetsGetPresets } from "@openrouter/sdk/funcs/presetsGetPresets.js";
...
async function run() {
  const res = await presetsGetPresets(openRouter, {
    slug: "my-preset",
  });
  if (res.ok) {
    ...
    console.log("presetsGetPresets failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetPresetsRequest](../../models/operations/getpresetsrequest.md)                                                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.GetPresetsResponse](../../models/operations/getpresetsresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="listPresetsVersions" method="get" path="/presets/{slug}/versions/{version}" -->
```typescript
import { OpenRouter } from "@openrouter/sdk";
...
async function run() {
  const result = await openRouter.presets.listPresetsVersions({
    slug: "my-preset",
    version: "1",
  });
...
```typescript
import { OpenRouterCore } from "@openrouter/sdk/core.js";
import { presetsListPresetsVersions } from "@openrouter/sdk/funcs/presetsListPresetsVersions.js";
...
async function run() {
  const res = await presetsListPresetsVersions(openRouter, {
    slug: "my-preset",
    version: "1",
  });
  if (res.ok) {
    ...
    console.log("presetsListPresetsVersions failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.ListPresetsVersionsRequest](../../models/operations/listpresetsversionsrequest.md)                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.GetPresetVersionResponse](../../models/getpresetversionresponse.md)\>**
