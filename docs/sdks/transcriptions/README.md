...
async function run() {
  const result = await openRouter.transcriptions.createTranscription({
    sttRequest: {
      inputAudio: {
        data: "UklGRiQA...",
        format: "wav",
...
import { transcriptionsCreateTranscription } from "@openrouter/sdk/funcs/transcriptionsCreateTranscription.js";
...
async function run() {
  const res = await transcriptionsCreateTranscription(openRouter, {
    sttRequest: {
      inputAudio: {
        data: "UklGRiQA...",
        format: "wav",
  ...
  if (res.ok) {
    ...
    console.log("transcriptionsCreateTranscription failed:", res.error);
  }
}
