...
* [getPrivateModel](#getprivatemodel) - Get a private model
* [listPrivateModelEndpoints](#listprivatemodelendpoints) - List endpoints for a private model
...
async function run() {
  const result = await openRouter.models.getPrivateModel({
    bearer: process.env["OPENROUTER_BEARER"] ?? "",
  }, {
    author: "openai",
    slug: "gpt-4",
...
```typescript
import { OpenRouterCore } from "@openrouter/sdk/core.js";
import { modelsGetPrivateModel } from "@openrouter/sdk/funcs/modelsGetPrivateModel.js";
...
async function run() {
  const res = await modelsGetPrivateModel(openRouter, {
    bearer: process.env["OPENROUTER_BEARER"] ?? "",
  }, {
    author: "openai",
    slug: "gpt-4",
  ...
  if (res.ok) {
    ...
    console.log("modelsGetPrivateModel failed:", res.error);
  }
}
...
async function run() {
  const result = await openRouter.models.listPrivateModelEndpoints({
    bearer: process.env["OPENROUTER_BEARER"] ?? "",
  }, {
    author: "openai",
    slug: "gpt-4",
...
```typescript
import { OpenRouterCore } from "@openrouter/sdk/core.js";
import { modelsListPrivateModelEndpoints } from "@openrouter/sdk/funcs/modelsListPrivateModelEndpoints.js";
...
async function run() {
  const res = await modelsListPrivateModelEndpoints(openRouter, {
    bearer: process.env["OPENROUTER_BEARER"] ?? "",
  }, {
    author: "openai",
    slug: "gpt-4",
  ...
  if (res.ok) {
    ...
    console.log("modelsListPrivateModelEndpoints failed:", res.error);
  }
}
