...
| `security`                                                                                                                                                                     | [operations.GetUserActivitySecurity](../../models/operations/getuseractivitysecurity.md)                                                                                       | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
