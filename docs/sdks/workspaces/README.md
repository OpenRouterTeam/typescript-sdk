...
Delete an existing workspace. The default workspace cannot be deleted. Workspaces with active API keys or members cannot be deleted. [Management key](/docs/guides/overview/auth/management-api-keys) required.
...
Get a single workspace by ID. [Management key](/docs/guides/overview/auth/management-api-keys) required.
...
Update an existing workspace. [Management key](/docs/guides/overview/auth/management-api-keys) required.
