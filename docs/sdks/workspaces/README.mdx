...
Delete an existing workspace. A workspace with active API keys cannot be deleted; remove the keys first. An account's last remaining workspace cannot be deleted. [Management key](/docs/guides/overview/auth/management-api-keys) required.
