...
* [getBenchmarksArtificialAnalysis](#getbenchmarksartificialanalysis) - Artificial Analysis Benchmark Rankings
...
<!-- UsageSnippet language="typescript" operationID="getBenchmarksArtificialAnalysis" method="get" path="/datasets/api/v1/datasets/benchmarks/artificial-analysis" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="getBenchmarksDesignArena" method="get" path="/datasets/api/v1/datasets/benchmarks/design-arena" -->
```typescript
import { OpenRouter } from "@openrouter/sdk";
