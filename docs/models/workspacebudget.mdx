...
| `resetInterval`                                                          | [models.ResetInterval](../models/resetinterval.mdx)                       | :heavy_check_mark:                                                       | Interval at which spend resets. Null means a lifetime (one-time) budget. | monthly                                                                  |
