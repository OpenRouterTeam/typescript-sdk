...
| `metadata`                                                             | [models.InternChatErrorMetadata](../models/internchaterrormetadata.mdx) | :heavy_check_mark:                                                     | Machine-readable detail for the failure.                               | \{<br/>"reason": "interaction_not_pending",<br/>"retryable": false<br/>} |