...
| `provider`                                                                                                    | [models.SpeechRequestProvider](../models/speechrequestprovider)                                            | :heavy_minus_sign:                                                                                            | Provider-specific passthrough configuration                                                                   |                                                                                                               |
| `responseFormat`                                                                                              | [models.SpeechRequestResponseFormat](../models/speechrequestresponseformat)                                | :heavy_minus_sign:                                                                                            | Audio output format                                                                                           | pcm                                                                                                           |
...
| `voice`                                                                                                       | *string*                                                                                                      | :heavy_check_mark:                                                                                            | Voice identifier (provider-specific).                                                                         | en_paul_neutral                                                                                               |