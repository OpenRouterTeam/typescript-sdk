---
title: "ChatSystemMessageConfigurationUpdate"
---
...
```typescript
import { ChatSystemMessageConfigurationUpdate } from "@openrouter/sdk/models";

let value: ChatSystemMessageConfigurationUpdate = {
  reasoning: {
    effort: "low",
  },
};
