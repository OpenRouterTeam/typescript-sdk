...
| `apiType`                                                                   | [models.ApiType](../models/apitype.md)                                      | :heavy_check_mark:                                                          | Type of API used for the generation                                         | completions                                                                 |
...
| `userAgent`                                                                 | *string*                                                                    | :heavy_check_mark:                                                          | User-Agent header from the request                                          | Mozilla/5.0                                                                 |
| `httpReferer`                                                               | *string*                                                                    | :heavy_check_mark:                                                          | Referer header from the request                                             | https://openrouter.ai/                                                      |
