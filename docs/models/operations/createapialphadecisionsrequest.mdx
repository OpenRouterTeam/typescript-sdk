---
title: "CreateApiAlphaDecisionsRequest"
---

## Example Usage

```typescript
import { CreateApiAlphaDecisionsRequest } from "@openrouter/sdk/models/operations";

let value: CreateApiAlphaDecisionsRequest = {
  decisionsRequest: {
    model: "Escalade",
    questions: {},
    state: {},
