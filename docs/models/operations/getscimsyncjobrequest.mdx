---
title: "GetScimSyncJobRequest"
---

## Example Usage

```typescript
import { GetScimSyncJobRequest } from "@openrouter/sdk/models/operations";

let value: GetScimSyncJobRequest = {
  id: "947f8e11-ccdd-447d-8cd1-30480eb3f057",
};
```
