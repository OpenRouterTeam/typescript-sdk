...
| `createBYOKKeyRequest`                                                                                                                            | [models.CreateBYOKKeyRequest](../../models/createbyokkeyrequest)                                                                               | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"key": "sk-proj-abc123...",<br/>"name": "Production OpenAI Key",<br/>"provider": "openai"<br/>}                                             |