---
title: "CreateApiAlphaDecisionsGlobals"
---

## Example Usage

```typescript
import { CreateApiAlphaDecisionsGlobals } from "@openrouter/sdk/models/operations";

let value: CreateApiAlphaDecisionsGlobals = {};
```
