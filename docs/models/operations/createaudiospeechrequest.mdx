...
| `speechRequest`                                                                                                                                   | [models.SpeechRequest](../../models/speechrequest.mdx)                                                                                             | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"input": "Hello world",<br/>"model": "elevenlabs/eleven-turbo-v2",<br/>"response_format": "pcm",<br/>"speed": 1,<br/>"voice": "alloy"<br/>} |