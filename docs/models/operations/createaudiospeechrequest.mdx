...
| `speechRequest`                                                                                                                                   | [models.SpeechRequest](../../models/speechrequest)                                                                                             | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"input": "Hello world",<br/>"model": "mistralai/voxtral-mini-tts-2603",<br/>"response_format": "pcm",<br/>"speed": 1,<br/>"voice": "en_paul_neutral"<br/>} |