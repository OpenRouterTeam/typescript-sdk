---
title: "DeleteInternVaultSecretGlobals"
---

## Example Usage

```typescript
import { DeleteInternVaultSecretGlobals } from "@openrouter/sdk/models/operations";

let value: DeleteInternVaultSecretGlobals = {};
```
