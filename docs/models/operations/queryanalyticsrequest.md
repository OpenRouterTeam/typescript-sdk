...
```typescript
import { QueryAnalyticsRequest } from "@openrouter/sdk/models/operations";

let value: QueryAnalyticsRequest = {
  requestBody: {
    metrics: [
      "request_count",
    ],
...
| `requestBody`                                                                                                                                     | [operations.QueryAnalyticsRequestBody](../../models/operations/queryanalyticsrequestbody.md)                                                      | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               |