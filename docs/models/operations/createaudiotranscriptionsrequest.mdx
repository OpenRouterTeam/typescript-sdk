...
| `sttRequest`                                                                                                                                      | [models.STTRequest](../../models/sttrequest.mdx)                                                                                                   | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"input_audio": \{<br/>"data": "UklGRiQA...",<br/>"format": "wav"<br/>},<br/>"language": "en",<br/>"model": "openai/whisper-large-v3"<br/>}   |