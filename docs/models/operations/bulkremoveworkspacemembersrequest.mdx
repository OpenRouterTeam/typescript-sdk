...
| `workspaceId`                                                                                                                                     | *string*                                                                                                                                          | :heavy_check_mark:                                                                                                                                | The workspace ID (UUID) or slug                                                                                                                   | production                                                                                                                                        |
| `bulkRemoveWorkspaceMembersRequest`                                                                                                               | [models.BulkRemoveWorkspaceMembersRequest](../../models/bulkremoveworkspacemembersrequest.mdx)                                                     | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"user_ids": [<br/>"user_abc123",<br/>"user_def456"<br/>]<br/>}                                                                              |