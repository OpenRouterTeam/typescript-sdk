...
| `bulkRemoveWorkspaceMembersRequest`                                                                                                               | [models.BulkRemoveWorkspaceMembersRequest](../../models/bulkremoveworkspacemembersrequest)                                                     | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"user_ids": [<br/>"user_abc123",<br/>"user_def456"<br/>]<br/>}                                                                              |