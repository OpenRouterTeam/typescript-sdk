...
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `datacenters`                                                         | [operations.Datacenter](../../models/operations/datacenter)[]      | :heavy_minus_sign:                                                    | ISO 3166-1 Alpha-2 country codes of the provider datacenter locations | [<br/>"US",<br/>"IE"<br/>]                                            |
| `headquarters`                                                        | [operations.Headquarters](../../models/operations/headquarters)    | :heavy_minus_sign:                                                    | ISO 3166-1 Alpha-2 country code of the provider headquarters          | US                                                                    |
