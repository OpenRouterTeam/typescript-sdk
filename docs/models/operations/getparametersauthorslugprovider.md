# GetParametersAuthorSlugProvider

## Example Usage

```typescript
import { GetParametersAuthorSlugProvider } from "@openrouter/sdk/models/operations";

let value: GetParametersAuthorSlugProvider = "Infermatic";
```
