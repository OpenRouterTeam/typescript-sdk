# ListUserModelsSupportedParameter

## Example Usage

```typescript
import { ListUserModelsSupportedParameter } from "@openrouter/sdk/models/operations";

let value: ListUserModelsSupportedParameter = "temperature";
```
