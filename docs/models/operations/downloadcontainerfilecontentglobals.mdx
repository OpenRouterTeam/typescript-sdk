---
title: "DownloadContainerFileContentGlobals"
---

## Example Usage

```typescript
import { DownloadContainerFileContentGlobals } from "@openrouter/sdk/models/operations";

let value: DownloadContainerFileContentGlobals = {};
```
