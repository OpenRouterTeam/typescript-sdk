...
| `bulkAssignMembersRequest`                                                                                                                        | [models.BulkAssignMembersRequest](../../models/bulkassignmembersrequest)                                                                       | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"member_user_ids": [<br/>"user_abc123",<br/>"user_def456"<br/>]<br/>}                                                                       |