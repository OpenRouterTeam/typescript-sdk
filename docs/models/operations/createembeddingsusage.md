...
| `promptTokensDetails`                                                                                    | [operations.PromptTokensDetails](../../models/operations/prompttokensdetails.md)                         | :heavy_minus_sign:                                                                                       | Per-modality token breakdown. Only present when the upstream provider returns modality-level usage data. |                                                                                                          |
