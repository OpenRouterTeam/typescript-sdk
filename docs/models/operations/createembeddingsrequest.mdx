...
| `requestBody`                                                                                                                                     | [operations.CreateEmbeddingsRequestBody](../../models/operations/createembeddingsrequestbody.mdx)                                                  | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"dimensions": 1536,<br/>"input": "The quick brown fox jumps over the lazy dog",<br/>"model": "openai/text-embedding-3-small"<br/>}          |