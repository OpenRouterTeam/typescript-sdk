...
| `bulkAddWorkspaceMembersRequest`                                                                                                                  | [models.BulkAddWorkspaceMembersRequest](../../models/bulkaddworkspacemembersrequest.mdx)                                                           | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               | \{<br/>"user_ids": [<br/>"user_abc123",<br/>"user_def456"<br/>]<br/>}                                                                              |