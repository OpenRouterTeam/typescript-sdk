---
title: "ProvisionOrganizationRequest"
---

## Example Usage

```typescript
import { ProvisionOrganizationRequest } from "@openrouter/sdk/models/operations";

let value: ProvisionOrganizationRequest = {
  requestBody: {
    email: "Johathan_Kling@gmail.com",
    externalId: "<id>",
    name: "<value>",
    paymentToken: "<value>",
    scopes: [],
...
| `requestBody`                                                                                                                                     | [operations.ProvisionOrganizationRequestBody](../../models/operations/provisionorganizationrequestbody.mdx)                                        | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               |