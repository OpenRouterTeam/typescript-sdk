...
```typescript
import { CreateAudioSpeechRequestBody } from "@openrouter/sdk/models/operations";

let value: CreateAudioSpeechRequestBody = {
  input: "Hello world",
...
| `voice`                                                                                                       | *string*                                                                                                      | :heavy_check_mark:                                                                                            | Voice identifier                                                                                              | alloy                                                                                                         |