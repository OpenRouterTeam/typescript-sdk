---
title: "CopyVaultSecretsToInternGlobals"
---

## Example Usage

```typescript
import { CopyVaultSecretsToInternGlobals } from "@openrouter/sdk/models/operations";

let value: CopyVaultSecretsToInternGlobals = {};
```
