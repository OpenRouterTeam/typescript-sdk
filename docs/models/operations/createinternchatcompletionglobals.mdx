---
title: "CreateInternChatCompletionGlobals"
---

## Example Usage

```typescript
import { CreateInternChatCompletionGlobals } from "@openrouter/sdk/models/operations";

let value: CreateInternChatCompletionGlobals = {};
```
