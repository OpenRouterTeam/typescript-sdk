...
### `models.AnthropicCitationSearchResultLocationParam`

```typescript
const value: models.AnthropicCitationSearchResultLocationParam = {
  citedText: "Example cited text",
  endBlockIndex: 1,
  searchResultIndex: 0,
...
### `models.AnthropicCitationWebSearchResultLocationParam`

```typescript
const value: models.AnthropicCitationWebSearchResultLocationParam = {
  citedText: "Example cited text",
