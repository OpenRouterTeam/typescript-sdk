...
### `models.CompactOutputItemMessage`

```typescript
const value: models.CompactOutputItemMessage = {
  content: null,
  id: "cmp_abc123",
  role: "assistant",
  type: "message",
...
### `models.CompactOutputItemReasoning`

```typescript
const value: models.CompactOutputItemReasoning = {
  id: "cmp_abc123",
  summary: [
    {
...
### `models.OutputFilesServerToolItem`

```typescript
const value: models.OutputFilesServerToolItem = {
  status: "completed",
...
### `models.ContextCompactionItem`

```typescript
const value: models.ContextCompactionItem = {
...
### `models.AdditionalToolsItem`

```typescript
const value: models.AdditionalToolsItem = {
  role: "developer",
  tools: [
    {
      type: "function",
...
```typescript
const value: models.AgentMessageItem = {
  author: "/root/worker",
  content: [
    {
      text: "Task complete.",
...
### `models.CompactOutputItem`

```typescript
const value: models.CompactOutputItem = {
  type: "compaction",
};
```
