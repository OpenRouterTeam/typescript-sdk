...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `parameters`                                                                   | [models.McpServerToolConfig](../models/mcpservertoolconfig.md)                 | :heavy_check_mark:                                                             | Configuration for the openrouter:mcp server tool                               | {<br/>"server_label": "my-mcp-server",<br/>"server_url": "https://example.com/mcp"<br/>} |
