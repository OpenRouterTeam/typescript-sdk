---
title: "VideoGenerationProviderPreferencesOptions"
---
...
```typescript
import { VideoGenerationProviderPreferencesOptions } from "@openrouter/sdk/models";

let value: VideoGenerationProviderPreferencesOptions = {};
```
