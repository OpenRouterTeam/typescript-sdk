...
| `engine`                                                                                   | [models.ContextCompressionEngine](../models/contextcompressionengine)                   | :heavy_minus_sign:                                                                         | The compression engine to use. Defaults to "middle-out".                                   | middle-out                                                                                 |
