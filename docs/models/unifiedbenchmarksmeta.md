...
| `source`                                                                                     | [models.SourceEnum](../models/sourceenum.md)                                                 | :heavy_check_mark:                                                                           | The source filter applied.                                                                   | artificial-analysis                                                                          |
| `sourceUrl`                                                                                  | *string*                                                                                     | :heavy_check_mark:                                                                           | URL of the upstream data source.                                                             | https://artificialanalysis.ai                                                                |
