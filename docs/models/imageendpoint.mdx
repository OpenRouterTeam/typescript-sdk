...
| `pricing`                                                                                                                                                            | [models.ImagePricingEntry](../models/imagepricingentry)[]                                                                                                         | :heavy_check_mark:                                                                                                                                                   | Billable pricing lines for this endpoint.                                                                                                                            | [<br/>\{<br/>"billable": "output_image",<br/>"cost_usd": 0.05,<br/>"unit": "image"<br/>}<br/>]                                                                        |
