...
| `output`                                                                                 | [models.OutputShellCallOutputItemOutput](../models/outputshellcalloutputitemoutput)[] | :heavy_check_mark:                                                                       | N/A                                                                                      |                                                                                          |
| `status`                                                                                 | [models.ShellCallStatus](../models/shellcallstatus)                                   | :heavy_check_mark:                                                                       | Status of a shell call or its output.                                                    | completed                                                                                |
