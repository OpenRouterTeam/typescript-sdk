...
| `status`                                                                                                                          | [models.ApplyPatchCallStatus](../models/applypatchcallstatus)                                                                  | :heavy_check_mark:                                                                                                                | Lifecycle state of an `apply_patch_call` output item.                                                                             | completed                                                                                                                         |
| `type`                                                                                                                            | [models.ApplyPatchCallItemType](../models/applypatchcallitemtype)                                                              | :heavy_check_mark:                                                                                                                | N/A                                                                                                                               |                                                                                                                                   |