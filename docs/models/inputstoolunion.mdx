---
title: "InputsToolUnion"
---

## Supported Types

### `models.InputsToolFunction1`

```typescript
const value: models.InputsToolFunction1 = {
  name: "get_weather",
  parameters: {
    "properties": {
      "location": {
...
### `models.InputsToolFunction2`

```typescript
const value: models.InputsToolFunction2 = {
  name: "get_weather",
  parameters: {
    "properties": {
      "location": {
