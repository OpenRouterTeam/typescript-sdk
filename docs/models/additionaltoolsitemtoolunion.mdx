...
### `models.AdditionalToolsItemToolFunction`

```typescript
const value: models.AdditionalToolsItemToolFunction = {
  name: "get_weather",
  parameters: {
    "properties": {
      "location": {
...
### `models.AudioGenerationServerToolOpenRouter`

```typescript
const value: models.AudioGenerationServerToolOpenRouter = {
  type: "openrouter:audio_generation",
};
```

### `models.SearchModelsServerToolOpenRouter`

```typescript
const value: models.SearchModelsServerToolOpenRouter = {
...
### `models.AdditionalToolsItemTool`

```typescript
const value: models.AdditionalToolsItemTool = {
  type: "<value>",
};
```
