...
### `models.OpenResponsesInputMessage`

```typescript
const value: models.OpenResponsesInputMessage = {
  id: "msg-abc123",
  role: "assistant",
  type: "message",
  content: [
...
### `models.OpenResponsesInputReasoning`

```typescript
const value: models.OpenResponsesInputReasoning = {
  type: "reasoning",
  id: "reasoning-abc123",
  summary: [
    {
