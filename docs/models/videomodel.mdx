...
| `creativity`                                                                               | *number*[]                                                                                 | :heavy_check_mark:                                                                         | Supported creativity levels for video upscaling models                                     |                                                                                            |
...
| `supportedAspectRatios`                                                                    | [models.SupportedAspectRatio](../models/supportedaspectratio.mdx)[]                         | :heavy_check_mark:                                                                         | Supported output aspect ratios                                                             |                                                                                            |
| `supportedDurations`                                                                       | *number*[]                                                                                 | :heavy_check_mark:                                                                         | Supported video durations in seconds                                                       |                                                                                            |
| `supportedFrameImages`                                                                     | [models.SupportedFrameImage](../models/supportedframeimage.mdx)[]                           | :heavy_check_mark:                                                                         | Supported frame image types (e.g. first_frame, last_frame)                                 |                                                                                            |
| `supportedResolutions`                                                                     | [models.SupportedResolution](../models/supportedresolution.mdx)[]                           | :heavy_check_mark:                                                                         | Supported output resolutions                                                               |                                                                                            |
| `supportedSizes`                                                                           | [models.SupportedSize](../models/supportedsize.mdx)[]                                       | :heavy_check_mark:                                                                         | Supported output sizes (width x height)                                                    |                                                                                            |
| `upscaleFactor`                                                                            | [models.UpscaleFactor](../models/upscalefactor.mdx)                                         | :heavy_check_mark:                                                                         | Supported upscale factor range for video upscaling models                                  |                                                                                            |