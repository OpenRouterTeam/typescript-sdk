...
| ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ |
| `parameters`                                                       | [models.FilesServerToolConfig](../models/filesservertoolconfig) | :heavy_minus_sign:                                                 | Configuration for the openrouter:files server tool                 | \{}                                                                 |
| `type`                                                             | [models.FilesServerToolType](../models/filesservertooltype)     | :heavy_check_mark:                                                 | N/A                                                                |                                                                    |