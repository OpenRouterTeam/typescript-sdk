...
let value: BenchmarksDAMeta = {
  ...
  category: null,
  citation:
    "Source: Design Arena (designarena.dev) via OpenRouter (openrouter.ai/rankings).",
  eloBounds: {
    max: 1600,
    min: 900,
  },
  modelCount: 50,
  source: "design-arena",
  sourceUrl: "https://designarena.dev",
  version: "v1",
};
```
...
| `citation`                                                                      | *string*                                                                        | :heavy_check_mark:                                                              | Required attribution when republishing this data.                               | Source: Design Arena (designarena.dev) via OpenRouter (openrouter.ai/rankings). |
...
| `source`                                                                        | [models.BenchmarksDAMetaSource](../models/benchmarksdametasource.md)            | :heavy_check_mark:                                                              | Data source identifier.                                                         |                                                                                 |
| `sourceUrl`                                                                     | [models.BenchmarksDAMetaSourceUrl](../models/benchmarksdametasourceurl.md)      | :heavy_check_mark:                                                              | URL of the upstream data source.                                                |                                                                                 |
