...
| `defaultGuardrailId`                                                                 | *string*                                                                             | :heavy_check_mark:                                                                   | Deterministic ID of the workspace's implicitly-created default guardrail             | 595d5849-7e86-51fd-a7c0-705c34e4afff                                                 |
