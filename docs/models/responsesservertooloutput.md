...
```typescript
import { ResponsesServerToolOutput } from "@openrouter/sdk/models";

let value: ResponsesServerToolOutput = {
...
| `status`                                                                               | [models.ResponsesServerToolOutputStatus](../models/responsesservertooloutputstatus.md) | :heavy_check_mark:                                                                     | N/A                                                                                    |                                                                                        |
