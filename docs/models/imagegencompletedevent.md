...
| `usage`                                                                               | [models.CompletionResponseUsage](../models/completionresponseusage.md)                | :heavy_minus_sign:                                                                    | Token and cost usage for the image generation request, when available                 | {<br/>"completion_tokens": 150,<br/>"cost": 0.001,<br/>"prompt_tokens": 25,<br/>"total_tokens": 175<br/>} |