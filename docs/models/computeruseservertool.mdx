...
| `environment`                                                              | [models.Environment](../models/environment)                             | :heavy_check_mark:                                                         | N/A                                                                        |
| `type`                                                                     | [models.ComputerUseServerToolType](../models/computeruseservertooltype) | :heavy_check_mark:                                                         | N/A                                                                        |