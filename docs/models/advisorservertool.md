...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `parameters`                                                           | [models.AdvisorServerToolConfig](../models/advisorservertoolconfig.md) | :heavy_check_mark:                                                     | Configuration for the openrouter:advisor server tool                   | {<br/>"max_uses": 3,<br/>"model": "anthropic/claude-opus-4-7"<br/>}    |
