...
const value: models.OutputDatetimeItem = {
  datetime: "2024-12-31T05:26:30.868Z",
  status: "completed",
...
### `models.OutputShellServerToolItem`

```typescript
const value: models.OutputShellServerToolItem = {
  status: "completed",
...
### `models.ConfigurationUpdateItem`

```typescript
const value: models.ConfigurationUpdateItem = {
  reasoning: {
    effort: "low",
  },
