...
| `type`                                                                                               | [models.OutputFunctionCallItemTypeFunctionCall](../models/outputfunctioncallitemtypefunctioncall.mdx) | :heavy_check_mark:                                                                                   | N/A                                                                                                  |
| `agent`                                                                                              | [models.OutputFunctionCallItemAgent](../models/outputfunctioncallitemagent.mdx)                       | :heavy_minus_sign:                                                                                   | N/A                                                                                                  |