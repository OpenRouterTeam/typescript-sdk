...
| `parameters`                                                                         | [models.SearchModelsServerToolConfig](../models/searchmodelsservertoolconfig.md)     | :heavy_minus_sign:                                                                   | Configuration for the openrouter:search_models server tool                           | {<br/>"max_results": 5<br/>}                                                         |