...
| `status`                                                                                                | [models.VideoGenerationResponseStatus](../models/videogenerationresponsestatus)                      | :heavy_check_mark:                                                                                      | N/A                                                                                                     |                                                                                                         |
| `unsignedUrls`                                                                                          | *string*[]                                                                                              | :heavy_minus_sign:                                                                                      | N/A                                                                                                     |                                                                                                         |
| `usage`                                                                                                 | [models.VideoGenerationUsage](../models/videogenerationusage)                                        | :heavy_minus_sign:                                                                                      | Usage and cost information for the video generation. Available once the job has completed.              | \{<br/>"cost": 0.5,<br/>"is_byok": false<br/>}                                                           |