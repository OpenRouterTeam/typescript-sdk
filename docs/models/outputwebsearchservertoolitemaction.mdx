...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| `query`                                                                                                | *string*                                                                                               | ✅                                                                                     | N/A                                                                                                    |
| `sources`                                                                                              | [models.OutputWebSearchServerToolItemSource](../models/outputwebsearchservertoolitemsource.mdx)[]       | ➖                                                                                     | N/A                                                                                                    |
| `type`                                                                                                 | [models.OutputWebSearchServerToolItemTypeSearch](../models/outputwebsearchservertoolitemtypesearch.mdx) | ✅                                                                                     | N/A                                                                                                    |