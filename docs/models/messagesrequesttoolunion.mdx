...
### `models.AnthropicWebFetchTool20260318`

```typescript
const value: models.AnthropicWebFetchTool20260318 = {
  name: "web_fetch",
...
### `models.AnthropicWebSearchTool20260318`

```typescript
const value: models.AnthropicWebSearchTool20260318 = {
  name: "web_search",
