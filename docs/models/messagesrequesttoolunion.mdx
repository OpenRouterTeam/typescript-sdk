...
### `models.ToolWebSearch20260318`

```typescript
const value: models.ToolWebSearch20260318 = {
  name: "web_search",
  type: "web_search_20260318",
};
```

### `models.ToolWebFetch20260318`

```typescript
const value: models.ToolWebFetch20260318 = {
  name: "web_fetch",
  type: "web_fetch_20260318",
};
```

### `models.ToolToolSearchToolBm2520251119`

```typescript
const value: models.ToolToolSearchToolBm2520251119 = {
