...
import { fromClaudeMessages, OpenRouter, toClaudeMessage } from '../src/index.js';
...
async function multiTurnClaudeConversation() {
  ...
  messages.push({
    role: 'user',
    content:
      'Can you show me an example of how the same problem would be solved differently in each paradigm?',
  });
  ...
  messages.push({
    role: 'user',
    content:
      'Which paradigm would you recommend for building a large-scale web application and why?',
  });
